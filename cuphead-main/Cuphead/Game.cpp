...
Game::Game(QWidget *parent)
    : QWidget(parent),
    player(QPointF(100, 350)),
    boss(QPointF(500, 350)),
    playerLives(3),
    ...
    pauseButton->setGeometry(700, 10, 80, 30); // Позиционирование и размер кнопки
...
void Game::updateLivesDisplay() {
    ...
    painter.drawText(10, 20, QString("Lives: %1").arg(1));

    // Отображение количества жизней босса
